...
public class GuiGameControllerTest {
    ...
    public void initialisesAndDisplaysEmptyBoard() {
        ...
        GuiGameController controller = GuiGameController.createGuiGameController(humanVsHumanGameConfiguration, gameRulesSpy, createViewFactory(), new GameTypeController());
    ...
    public void initialisesGameAndDisplaysBoardWithFirstAutomatedMove() {
        ...
        GuiGameController controller = GuiGameController.createGuiGameController(unbeatableVsHumanGameConfiguration, gameRulesSpy, createViewFactory(), new GameTypeController());
    ...
    public void humanVsComputerGameMeansBothPlayersTakeTurn() {
        ...
        gameRulesSpy = new TicTacToeRulesSpy(new Board(3), 1);
        GuiGameController controller = GuiGameController.createGuiGameController(humanVsUnbeatableGameConfiguration, gameRulesSpy, createViewFactory(), new GameTypeController());
